...
export const BentoGridItem = ({
  ...
  function handleCopy() {
    navigator.clipboard.writeText("materiamystic@gmail.com");
    setCopied(true);
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute right-1 lg:right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["React.js", "Next.js", "Typescript"].map((item) => (
                  <span
                    key={item}
                    className="py-2 px-3 lg:py-4 text-xs lg:text-base text-white opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132e] rounded-tr-2xl" />
                {["Python", "Django", "Postgres"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base text-white opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
